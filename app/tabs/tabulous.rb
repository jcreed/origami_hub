...
Tabulous.setup do |config|
  ...
  config.tabs do
    [
      ...
      [    :listings_tab     ,    'View Origamis' ,    listing_index_path     ,    true        ,    true        ],
      [    :orders_tab  ,    'View Orders'   ,    orders_path    ,    true        ,    true        ],
      [    :customers_new_tab  ,    'Sign Up'   ,    new_customer_path    ,    true        ,    true        ],
      #--------------------------------------------------------------------------------------------------#
      #    TAB NAME         |    DISPLAY TEXT    |    PATH             |    VISIBLE?    |    ENABLED?    #
      #--------------------------------------------------------------------------------------------------#
    ]
  ...
  config.actions do
    [
      ...
      [    :listing      ,    :all_actions    ,    :listings_tab     ],
      [    :customers       ,    :all_actions    ,    :customers_new_tab  ],
      [    :orders       ,    :all_actions    ,    :orders_tab  ],
      #------------------------------------------------------------#
      #    CONTROLLER    |    ACTION          |    TAB              #
      #-------------------------------------------------------------#
    ]
